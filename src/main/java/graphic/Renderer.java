...
public class Renderer {
    ...
    public void renderScene(EntNode entities, ComponentMask components){
        ...
        for (int i = 0; i < chunks.length; i++){
            ...
            for (int j = 0; j < chunk.getSize(); j++){
                ...
                float[] pos = position.getPosition(entity);
                float[] rot = rotation.getRotation(entity);
                if (entity.contains(components.getFromClasses(Scale.class))){
                    itemScale = scale.getScale(entity);
                }

                int itemID = modelData.getModel(entity);
                if (itemID == -1) {
                    mesh = meshData.getMesh(entity);
                }
    ...
    public void renderCircles(EntNode entities, ComponentMask components){
        ...
        for (int i = 0; i < balls.getSize(); i++) {
            ...
            float[] ballPosition = position.getPosition(ball);
            int ballRadius = radius.getRadius(ball);
            int ballHealth = health.getHealth(ball);
    ...
    private void setLightUniforms(EntNode entities, ComponentMask components){
        ...
        for (int i = 0; i < lights.getSize(); i++){
            ...
            float[] pos = position.getPosition(entity);
            int lightType = light.getLight(entity);
    ...
    private void setupSceneShader(){
        ...
        sceneShaderProgram.createVertexShader(loadResource("src/main/java/graphic/resources/shaders/scene_vertex.glsl"));
        sceneShaderProgram.createFragmentShader(loadResource("src/main/java/graphic/resources/shaders/scene_fragment.glsl"));
    ...
    private void setupTestShader(){
        ...
        textureShaderProgram.createVertexShader(loadResource("src/main/java/graphic/resources/shaders/texture_vertex.glsl"));
        textureShaderProgram.createFragmentShader(loadResource("src/main/java/graphic/resources/shaders/texture_fragment.glsl"));
    ...
    private void setupBloomShader() {
        ...
        bloomShaderProgram.createVertexShader(loadResource("src/main/java/graphic/resources/shaders/bloom_vertex.glsl"));
        bloomShaderProgram.createFragmentShader(loadResource("src/main/java/graphic/resources/shaders/bloom_fragment.glsl"));
    ...
    private void setupBallShader() {
        ...
        ballShaderProgram.createVertexShader(loadResource("src/main/java/graphic/resources/shaders/ball_vertex.glsl"));
        ballShaderProgram.createFragmentShader(loadResource("src/main/java/graphic/resources/shaders/ball_fragment.glsl"));
    ...
    private void setupBlendShader() {
        ...
        blendShaderProgram.createVertexShader(loadResource("src/main/java/graphic/resources/shaders/blend_vertex.glsl"));
        blendShaderProgram.createFragmentShader(loadResource("src/main/java/graphic/resources/shaders/blend_fragment.glsl"));
