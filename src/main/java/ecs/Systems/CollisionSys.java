...
public class CollisionSys extends System {
    ...
    @Override
    public Class update(float dt, EntNode entityTree, ComponentMask components, boolean indexChange) {
        java.lang.System.out.println("Updating CollisionSys");

        updateValues(dt, entityTree, components, indexChange);
    ...
    private void updateValues(float dt, EntNode entityTree, ComponentMask components, boolean indexChange){
        ...
        entityPositionIndices = getComponentIndices(Position.class, balls, components);
        ballVelocityIndices = getComponentIndices(Velocity.class, balls, components);
        ballRadiusIndices = getComponentIndices(Radius.class, balls, components);
