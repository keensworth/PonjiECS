...
public class ProceduralSys extends System {
    ...
    public Class update(float dt, EntNode entityTree, ComponentMask componentMask, boolean entityChange) {
        ...
        float[] cameraPos = position.getPosition(camera);
    ...
    private void updateValues(EntNode entityTree, ComponentMask componentMask){
        ...
        scale = (Scale) componentMask.getComponent(Scale.class);
        modelData = (ModelData) componentMask.getComponent(ModelData.class);
        meshData = (MeshData) componentMask.getComponent(MeshData.class);
