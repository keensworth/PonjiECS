...
public class Velocity extends Component {
    ...
    public float[] getVelocity(Entity entity){
        return getVelocity(this.getEntityIndex(entity.getEntityId()));
    }
    ...
    public void setVelocity(Entity entity, float[] velocity){
        setVelocity(this.getEntityIndex(entity.getEntityId()), velocity);
    }
