...
public class ProceduralSys extends System {
    ...
    private void loadNextChunk(){
        Container<Entity> nextChunk = generateChunk(currentChunk+1);
    ...
    private void loadPreviousChunk() {
        Container<Entity> previousChunk = generateChunk(currentChunk-1);
    ...
    private Container<Entity> generateChunk(int chunk){
        ...
        Container<Entity> flora   = generateEntities(chunk, natureObjectsNoise, FLORA_GENERATE);
        Container<Entity> objects = generateEntities(chunk, natureObjectsNoise, OBJECT_GENERATE);
        Container<Entity> trees   = generateEntities(chunk, treeNoise, TREE_GENERATE);
    ...
    private Container<Entity> generateEntities(int chunk, float[][] noise, int objectTag){
    ...
    private void initWorld(){
        Container<Entity> lowerChunk = generateChunk(-2);
        Container<Entity> lowerMiddleChunk = generateChunk(-1);
        Container<Entity> middleChunk = generateChunk(0);
        Container<Entity> upperMiddleChunk = generateChunk(1);
        Container<Entity> upperChunk = generateChunk(2);
